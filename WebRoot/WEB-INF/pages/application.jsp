...
<html>
	<head>
		...
		<script type="text/javascript" src="jslib/application.js"></script>
...
input,select,textarea {
	...
	<body onload="change('${studentDomain.userSex}','${studentDomain.userCategory}');">
		<center>
			<div id="container">
				<div id="top_info">
										...
										<fieldset id='allNoticeShow'>
											...
											<center>
												<div class="right_zone_studentin" id="application">
													<form action="messageFillAction" method="post">
