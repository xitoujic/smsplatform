...
/**
 	* A data access object (DAO) providing persistence and search support for TBdRechargeandconsumption entities.
...
public class TBdRechargeandconsumptionDAO extends BaseHibernateDAO  {
	     private static final Logger log = LoggerFactory.getLogger(TBdRechargeandconsumptionDAO.class);
		//property constants
    ...
    public List findByExample(TBdRechargeandconsumption instance) {
        ...
        try {
            List results = getSession()
                    .createCriteria("smsplatform.dao.TBdRechargeandconsumption")
    ...
    public List findByProperty(String propertyName, Object value) {
      log.debug("finding TBdRechargeandconsumption instance with property: " + propertyName
            + ", value: " + value);
      try {
    ...
    public TBdRechargeandconsumption merge(TBdRechargeandconsumption detachedInstance) {
