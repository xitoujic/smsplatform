...
/**
 	* A data access object (DAO) providing persistence and search support for TBdMessagesend entities.
...
public class TBdMessagesendDAO extends BaseHibernateDAO  {
	     private static final Logger log = LoggerFactory.getLogger(TBdMessagesendDAO.class);
		//property constants
    ...
    public TBdMessagesend findById( java.lang.Long id) {
        ...
        try {
            TBdMessagesend instance = (TBdMessagesend) getSession()
                    .get("smsplatform.dao.TBdMessagesend", id);
            return instance;
        } catch (RuntimeException re) {
    ...
    public List findByExample(TBdMessagesend instance) {
        ...
        try {
            List results = getSession()
                    .createCriteria("smsplatform.dao.TBdMessagesend")
    ...
    public List findByProperty(String propertyName, Object value) {
      log.debug("finding TBdMessagesend instance with property: " + propertyName
            + ", value: " + value);
      try {
    ...
    public TBdMessagesend merge(TBdMessagesend detachedInstance) {
        ...
        try {
            TBdMessagesend result = (TBdMessagesend) getSession()
