 ...
 * UserDomain entities. Transaction control of the save(), update() and delete()
...
public class UserDomainDAO extends BaseHibernateDAO {
	...
	public UserDomain findById(java.lang.Integer id) {
		...
		try {
			UserDomain instance = (UserDomain) getSession().get(
					"smsplatform.dao.UserDomain", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(UserDomain instance) {
		...
		try {
			List results = getSession().createCriteria(
					"smsplatform.dao.UserDomain").add(Example.create(instance))
					.list();
	...
	public UserDomain merge(UserDomain detachedInstance) {
		...
		try {
			UserDomain result = (UserDomain) getSession().merge(
					detachedInstance);
