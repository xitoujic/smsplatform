...
public class TBdUser  implements java.io.Serializable {
    ...
    /** full constructor */
    public TBdUser(String FUserName, String FUserFullName, String FPassword, String FPhoneNumber, Boolean FSex, String FRole, String FCompanyType, Boolean FCheckType, String FSignature, String FSignatureFlag, Boolean FUrgent, Boolean FUpdateStatus, Boolean FRight, Integer FDeductScale, String FEmail, Set TBdMessagesendgroups, Set TBdMessagenumbers, Set TBdRechargeandconsumptions) {
        this.FUserName = FUserName;
