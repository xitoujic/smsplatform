...
/**
 	* A data access object (DAO) providing persistence and search support for TBdMessagenumber entities.
...
public class TBdMessagenumberDAO extends BaseHibernateDAO  {
	     private static final Logger log = LoggerFactory.getLogger(TBdMessagenumberDAO.class);
		//property constants
    ...
    public TBdMessagenumber findById( smsplatform.dao.TBdMessagenumberId id) {
        ...
        try {
            TBdMessagenumber instance = (TBdMessagenumber) getSession()
                    .get("smsplatform.dao.TBdMessagenumber", id);
            return instance;
        } catch (RuntimeException re) {
    ...
    public List findByExample(TBdMessagenumber instance) {
        ...
        try {
            List results = getSession()
                    .createCriteria("smsplatform.dao.TBdMessagenumber")
    ...
    public List findByProperty(String propertyName, Object value) {
      log.debug("finding TBdMessagenumber instance with property: " + propertyName
            + ", value: " + value);
      try {
    ...
    public TBdMessagenumber merge(TBdMessagenumber detachedInstance) {
        ...
        try {
            TBdMessagenumber result = (TBdMessagenumber) getSession()
