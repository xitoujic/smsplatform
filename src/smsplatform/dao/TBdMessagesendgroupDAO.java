 ...
 * TBdMessagesendgroup entities. Transaction control of the save(), update() and
...
public class TBdMessagesendgroupDAO extends BaseHibernateDAO {
	private static final Logger log = LoggerFactory
			.getLogger(TBdMessagesendgroupDAO.class);
	// property constants
	...
	public List findByExample(TBdMessagesendgroup instance) {
		...
		try {
			List results = getSession().createCriteria(
					"smsplatform.dao.TBdMessagesendgroup").add(
	...
	public List findByProperty(String propertyName, Object value) {
		log.debug("finding TBdMessagesendgroup instance with property: "
