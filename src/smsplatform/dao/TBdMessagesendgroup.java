...
public class TBdMessagesendgroup  implements java.io.Serializable {
    ...
    /** full constructor */
    public TBdMessagesendgroup(TBdUser TBdUser, String FGroupType, String FSubmitType, String FGroupSendStatus, Long FGroupPhoneNum, String FGroupContent, Timestamp FGroupSendTime, Set TBdMessagesends) {
        this.TBdUser = TBdUser;
        this.FGroupType = FGroupType;
